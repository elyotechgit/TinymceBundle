/**
 * $Id: mcimagemanager.js 576 2008-11-10 12:47:03Z spocke $
 *
 * @author Moxiecode
...
(function() {
	window.mcImageManager = {
		...
		openWin : function(f, a) {
			...
			if (f.page)
				f.url = '/bundles/elyotechadmin/js/libraries/tiny_mce/plugins/imagemanager/index.php?type=im&page=' + f.page;
