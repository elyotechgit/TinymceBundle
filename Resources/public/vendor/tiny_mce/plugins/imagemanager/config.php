...
$mcImageManagerConfig['general.language'] = "fr"; // en, sv
...
$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../../../'; // absolute or relative from this script path, required.
...
$mcImageManagerConfig['filesystem.exclude_file_pattern'] = '/([^a-zA-Z0-9_\-\.]|^mcic_)|_thumb/i';//'/([^a-zA-Z0-9_\-\.]|^mcic_)|_thumb/i'
...
$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,swf,flv";
...
$mcImageManagerConfig['upload.format'] = "320x240=%f_thumb.%e";
...
// Edit image options
$mcImageManagerConfig['edit.jpeg_quality'] = "100";
