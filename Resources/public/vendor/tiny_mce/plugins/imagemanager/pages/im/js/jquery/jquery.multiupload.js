/**
 * $Id: jquery.multiupload.js 570 2008-11-07 13:52:52Z spocke $
 *
 * @author Moxiecode
...
(function($) {
	...
	$.multiUpload = function(s) {
		...
		$(this).trigger('multiUpload:setup');
		$(this).bind('multiUpload:selectFiles', function() {this.cache = {};});

		$(this).bind('multiUpload:filesSelected', function(e, fs) {
