...
(function() {
	...
	if (window.tinymce) {
		...
		tinymce.ScriptLoader.load(tinymce.PluginManager.urls['imagemanager'] + '/language/index.php?type=im&format=tinymce_3_x&group=tinymce&prefix=imagemanager_');
	}
	...
	if (window.TinyMCE_Engine) {
		var TinyMCE_ImageManagerPlugin = {
			setup : function() {
				...
				mcImageManager.baseURL = '/mcmanager_php/js';
			},
